...
Entity.prototype.applyServerCorrection = function (newCenter, newDirection) {
    ...
    var miniMe = Object.create(Entity.prototype)
    Entity.call(miniMe)

    for (var key of Object.keys(siOnServerSend.state)) {
        miniMe[key] = siOnServerSend.state[key]
    }
...
Entity.prototype.set3d = function (x, y, dx, dy) {
    ...
    if (isCorrection) {
        return this.applyServerCorrection(newCenter, newDirection)
    }
...
Entity.prototype.update = function (stateless) {
    ...
    if (this.clientsidePrediction && stateless !== true) {
        ...
        // Copy immutable props of mine into a state object
        var thisState = {
            input: {
                moving: this.moving,
                intendToShoot,
        ...
        for (var key of Object.keys(this)) {
            if (Object.isFrozen(this[key]) && key[0] !== '_') {
                thisState.state[key] = this[key]
            }
        }
