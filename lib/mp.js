...
HumanPlayer.prototype.shoot = function () {
    var bullet = new MortarBullet({ x: this.center.x, y: this.center.y }, this)
...
MortarBullet.prototype = Object.create(BazookaBullet.prototype)
...
GhostBullet.prototype = Object.create(BazookaBullet.prototype)
...
Networld.prototype._onPacket = function (packet) {
    ...
    packet.updates.forEach(function (update) {
        ...
        if (op === 'add') {
            ...
            assert(typeof Cls === 'function' && Cls.prototype instanceof Entity);
