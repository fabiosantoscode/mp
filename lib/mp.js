...
Entity.prototype.applyServerCorrection = function (newCenter, newDirection) {
    var nudge = (ms) => {
        ...
        this.smoothServerNudge.start = +new Date()
...
Entity.prototype.logStatesAndInputs = function () {
    if (!this.pastStatesAndInputs) { this.pastStatesAndInputs = [] }
